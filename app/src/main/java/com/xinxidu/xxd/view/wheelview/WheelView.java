...
package com.xinxidu.xxd.view.wheelview;
...
import com.xinxidu.xxd.view.wheelview.adapter.WheelViewAdapter;
...
//		int offset = 60;
		...
		paint.setColor(getResources().getColor(R.color.dan_back));
		// 设置线宽
