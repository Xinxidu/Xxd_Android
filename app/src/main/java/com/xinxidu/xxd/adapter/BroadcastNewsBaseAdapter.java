 ...
 */
public class BroadcastNewsBaseAdapter extends RecyclerView.Adapter<BroadcastNewsBaseAdapter.ViewHolder> {
    private final Context mContext;

    private List<BroadcastNewsItemEvent> mItemList = new ArrayList<BroadcastNewsItemEvent>();

    public BroadcastNewsBaseAdapter(Context mContext, List<BroadcastNewsItemEvent> itemList, Context context) {
        mItemList = itemList;
    ...
    public BroadcastNewsBaseAdapter(Context context) {
        mContext = context;
    }
